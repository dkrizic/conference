  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      client({
        ...
        _this2.setState({
          events: response.entity._embedded.events
        });
      });
    }
  }, {
...
function (_React$Component2) {
  ...
  function EventList() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(EventList).apply(this, arguments));
  }
  ...
  _createClass(EventList, [{
    ...
    value: function render() {
      ...
      return React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("th", null, "Event"), React.createElement("th", null, "Location"), React.createElement("th", null, "Start"), React.createElement("th", null, "End")), events));
    }
  }]);
...
function (_React$Component3) {
  ...
  _createClass(Event, [{
    key: "render",
    value: function render() {
      return React.createElement("tr", null, React.createElement("td", null, this.props.event.name), React.createElement("td", null, this.props.event.location.name), React.createElement("td", null, this.props.event.startDate), React.createElement("td", null, this.props.event.endDate));
    }
  }]);
